...
date: '2026-01-01'
publishDate: '2026-07-23T03:38:49.315269Z'
publication_types:
- paper-conference
...
abstract: Estimating slide- and patch-level gene expression profiles from pathology
  images enables rapid and low-cost molecular analysis with broad clinical impact.  Despite
  strong results, existing approaches treat gene expression as a mere slide- or spot-level
  signal and do not incorporate the fact that the measured expression arises from
  the aggregation of underlying cell-level expression. To explicitly introduce this
  missing cell-resolved guidance, we propose a Cell-type Prototype-informed Neural
  ...
  first estimate cell-type prototypes—mean expression profiles that capture stable
  ...
  cell types drive the predicted expression. The code will be made publicly available
  upon acceptance. The code is available at https://github.com/naivete5656/CPNN.
---
